using Kofoten.NativeCli.Generator.Data;
using Kofoten.NativeCli.Generator.Diagnostics;
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        var simpleCliCompilationContextProvider = context.CompilationProvider.Select(static (compilation, _) =>
        {
            ...
            return new SimpleCliCompilationContext(
                ...
                CliParserAttributeSymbol: compilation.GetTypeByMetadataName("Kofoten.NativeCli.CliParserAttribute"),
                CliKeyParserAttributeSymbol: compilation.GetTypeByMetadataName("Kofoten.NativeCli.CliKeyParserAttribute"),
